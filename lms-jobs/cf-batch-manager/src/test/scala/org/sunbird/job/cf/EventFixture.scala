...
object EventFixture {
  ...
  def mapToEvent(eventMap: java.util.Map[String, AnyRef]): org.sunbird.job.cf.domain.Event = {
    new org.sunbird.job.cf.domain.Event(eventMap.asInstanceOf[java.util.Map[String, Any]], 0, 0L)
  }
